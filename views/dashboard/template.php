            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <span class="pro-user-name ms-1">
                       <?= $_SESSION['user']['username']  ?> <i class="mdi mdi-chevron-down"></i> 
                    </span>
                </a>
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-xl-block">
                ...
                <div class="dropdown-menu">
                    ...
                    <!-- item-->
                    <a href="dashboard/create_operator" class="dropdown-item">
                        <i class="fe-briefcase me-1"></i>
                        <span>Magasin</span>
                    </a>

                    <a href="dashboard/create_user" class="dropdown-item">
                        <i class="fe-briefcase me-1"></i>
                        <span>Utilisateur</span>
                    </a>
                    <?php else: ?>
                    <a href="dashboard/create_product" class="dropdown-item">
                        <i class="fe-briefcase me-1"></i>
                        <span>Produit</span>
                    </a>
                    <?php endif; ?>
...
<!-- end Topbar -->
                ...
                <div class="h-100" data-simplebar>
                    ...
                    <div class="user-box text-center">
                        ...
                        <div class="dropdown">
                            <a href="javascript: void(0);" class="text-dark dropdown-toggle h5 mt-2 mb-1 d-block"
                                data-bs-toggle="dropdown"><?= $_SESSION['user']['username'] ?></a>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul id="side-menu">
                            ...
                            <li class="menu-title mt-2">Gerer</li>
                            <?php if($user['super_user'] == 1): ?>
                            <li>
                                <a href="dashboard/operators_list">
                                    <i data-feather="shopping-cart"></i>
                                    <span> Magasins </span> <span class="badge bg-success rounded-pill float-end"><?= count($operators) != 0 ? count($operators) : "0" ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="dashboard/users_list">
                                    <i data-feather="users"></i>
                                    <span> Utilisateurs </span> <span class="badge bg-success rounded-pill float-end"><?= count($users) != 0 ? count($users) : "0" ?></span>
                                </a>
                            </li>
                            <li>
    ...
    <?= $content ?>
        ...
        feather.replace();
        //if a certain country is selected
        $(document).on('change','.country_selector', function(){

            var country_id = $(this).children(":selected").attr("id");
            fetch_country_states(country_id);
            
        });
        //

        $(document).on('change','.tri_products', function(){

        var tri_id = $(this).children(":selected").attr("id");

        if(tri_id == 2){
            var url = "dashboard/products_list?tri=low_price";
            $(location).attr('href',url);
        }else if(tri_id == 3){
            var url = "dashboard/products_list?tri=high_price";
            $(location).attr('href',url);
        }
        ...
        function fetch_country_states(country_id){
            var url = 'dashboard/fetch_country_states';
            $.ajax({
                type:'POST',
                url:url,
                data: {
        ...
        //if a certain state is selected
        $(document).on('change','.state_selector', function(){

        var state_id = $(this).children(":selected").attr("id");
        fetch_state_cities(state_id);
