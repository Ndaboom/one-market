<footer>
					...
					<div class="col-lg-4 col-md-6">
						<div class="widget-ft widget-newsletter">
							...
							<ul class="pay-list">
								<li>
									<a href="#" title="">
										<img src="assets/landing/images/logos/ft-01.png" alt="">
									</a>
								</li>
								<li>
									<a href="#" title="">
										<img src="assets/landing/images/logos/ft-02.png" alt="">
									</a>
								</li>
								<li>
									<a href="#" title="">
										<img src="assets/landing/images/logos/ft-03.png" alt="">
									</a>
								</li>
								<li>
									<a href="#" title="">
										<img src="assets/landing/images/logos/ft-04.png" alt="">
									</a>
								</li>
								<li>
									<a href="#" title="">
										<img src="assets/landing/images/logos/ft-05.png" alt="">
									</a>
								</li>
							</ul><!-- /.pay-list -->
						...
						<div class="widget widget-apps">
							...
							<ul class="app-list">
								<li class="app-store">
									<a href="#" title="">
										<div class="img">
											<img src="assets/landing/images/icons/app-store.png" alt="">
										</div>
										<div class="text">
											<h4>App Store</h4>
								...
								<li class="google-play">
									<a href="#" title="">
										<div class="img">
											<img src="assets/landing/images/icons/google-play.png" alt="">
										</div>
										<div class="text">
											<h4>Google Play</h4>
											<p>Get in on</p>
		...
		<section class="footer-bottom">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<p class="copyright"> All Rights Reserved © One market 2022</p>
						<p class="btn-scroll">
							<a href="#" title="">
								<img src="assets/landing/images/icons/top.png" alt="">
							</a>
						</p>
					</div><!-- /.col-md-12 -->
				</div><!-- /.row -->
